...
const I18N = {
  'zh': {
    ...
    'filter.tutorial': '教程',
    'filter.agent': 'エージェント',
    'filter.open-source': 'オープンソース',
    'filter.safety': '安全性',
    'filter.multimodal': 'マルチモーダル',
    'filter.coding': 'コーディング',
    'filter.robotics': 'ロボティクス',
    'filter.video': '動画',
    'filter.speech': '音声',
    'filter.deployment': 'デプロイ',
    'filter.policy': '政策',
    'filter.open-source': '开源',
    'filter.safety': '安全',
